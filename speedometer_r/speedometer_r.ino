...
void loop() {
  ...
  delay(10);                                                //Test med og uten delay
  ...
  {                     
    ...
    {                      
      maxSpeed = meters_per_second;                         //Lagrer maks hastighet til en variabel 
    }
    ...
    { 
      unsigned long my_time = millis()-last_ten_sec;
      int batteryLevel = batteryCalc(float batteryLevel, float motorSpeed)      //Bruker batteryCalc-funksjonen til å regne ut batterinivået
      ...
      last_ten_sec = millis();                              //Oppdaterer variabel last_ten_sec
